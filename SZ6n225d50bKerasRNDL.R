...
# 入力と出力の分離
 ...
 y_train <- train_data$n225l　　　 #n225l 安値
...
　print(paste("ランダムありの安値予測値（元スケール）: ", round(y_pred_original, 2)))
