...
# ただしn225d50b.csvの全行は最初にランダムに並べ替えること。
...
# ランダムの変化点はここだけ。
# n225d50b.csv ランダムに並び替え
# NumPyの乱数生成を固定　42は任意の数字

df_shuffled <- df$sample(frac = 1.0, random_state = 42L)$reset_index(drop = TRUE)
